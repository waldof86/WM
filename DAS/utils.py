...
# My Code Extension
class Degree:
    def __init__(self, degree: str, institution: str, date_range: str, fields: str):
        self.degree = degree
...
##TODO: Agregar field
    def reprJSON(self):
        return dict(degree=self.degree, institution=self.institution, date_range=self.date_range, fields=self.fields)
   
class Profile:
    def __init__(self, name: str, email: str, skills: [str], jobs: [Job], degrees: [Degree]):
        self.name = name
        self.email = email
        self.skills = skills
        self.jobs = jobs
    ...
    def reprJSON(self):
        return dict(name=self.name, email=self.email, skills=self.skills, jobs=self.jobs, degrees=self.degrees)
